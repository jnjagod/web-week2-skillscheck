...
let doubled = myNumbers.map(function(elem){return elem * 2})

//////////////////PROBLEM 15////////////////////

// Now lets use .filter to only get the nubmer(s) greater than 100. Call the new array 'filtered'

let filtered = myNumbers.filter(function(elem){return elem > 100})

//////////////////PROBLEM 16////////////////////

// Next up, reduce to get the total of the array. call the new array 'total'

let total = myNumbers.reduce(function(acc, elem){return acc + elem})
...
let myNumbersIndex = []
myNumbers.forEach(function(elem, i){myNumbersIndex.push(i)})
...
let forTheLoveOfGeorge = notGeorge.map(function(elem){return elem = 'George'})
...
let enemies = people.filter(function(elem){return elem.friend === false})
...
let totallyAwesome = people.reduce(function(acc, elem){return acc + elem.awesomeLevel}, 0)
